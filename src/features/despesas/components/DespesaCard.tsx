...
import useDespesasDetalhes from "@/src/features/despesas/hooks/useDespesasDetalhes";
...
export default function DespesasCard({
  valor,
  cor = "red",
  previousMonthValue,
  style,
  ...
  return (
    <>
      ...
      <DetalhesModal
        ...
        titulo="Despesas"
        detalhes={despesas.map((d) => ({ ...d, data: d.data ?? "" }))}
      />
    </>
  );
}
